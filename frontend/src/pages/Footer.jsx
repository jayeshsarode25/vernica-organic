      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          <div className="lg:col-span-1">
            <h2><Logo/></h2>
            <p className="text-sm text-gray-600 mb-8">Your Tagline here</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-700">+91 9999 999 999</span>
            </div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm text-gray-700">youremailid.com</span>
            </div>
        ...
        <div className="border-t border-gray-300 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-600">
            2018 ©{" "}
            <span className="font-medium text-gray-800">company.Ltd</span> | All
            Right reserved
          </p>
